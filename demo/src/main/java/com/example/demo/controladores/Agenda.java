...
public class Agenda {
    ...
    // RF9: Agendar un servicio
    @PostMapping("/RF9")
    public ResponseEntity<String> rf9(@RequestBody Map<String, String> body) {
        try {
            ...
            AgendamientoService.agendarServicio(agendaId, ordenId, pacienteId);

            return ResponseEntity.ok("Servicio agendado correctamente");
